...
- **Platform-held balances and informal income**: Poshmark / eBay / Mercari / Depop / Etsy / Substack tips / Patreon / Buy Me a Coffee / OnlyFans balances often sit in the platform wallet until manually pulled to bank — aggregators typically miss them entirely. Plus informal off-platform side hustles (Facebook Marketplace flips, porch haircuts, off-the-books cash services, casual freelancing). Often $20-200/mo flows individually; adds up to real money over a year. Resale-platform balances especially are *literal money invisible to the holdings picture* until withdrawn — could be $200 sitting in Poshmark for three months unnoticed. *Real example from this session*: Marika transferred $78.49 from Poshmark → PayPal mid-conversation. Money had existed for some weeks; aggregator showed $0 the whole time; the transfer event made it visible. Demonstrates exactly the visibility gap this interrogation pass is meant to close.
- **Non-cash value flow**: bartering / in-kind exchange, non-monetary benefits received (free housing, employer-provided meals, comped services), crypto activity not in aggregator. **Spiritual-vibe-only exchanges count too** — if you traded something you can't precisely value (homemade bread, kid-watching, "I'll grout your bathtub if you fix my bike") and got back something you can't precisely value (truffle mushrooms, an heirloom, "watered the garden while I was gone"), capture the activity. Skip the dollar number; note the trade. Relationship-economy flows are real life-energy even when unpriced.
...
- **Time-bound government benefits and transition income**: unemployment insurance (UI), severance (sometimes ongoing rather than lump-sum), disability (SSDI / SSI / private), workers' comp, pandemic relief programs when active, COBRA subsidies, retraining stipends, GI Bill / education benefits. These are taxable, time-bound, and often missed in steady-state thinking — but materially affect the FU readout and bridge-years math during the active window. Skill should ask: *"Are you currently receiving any government benefits, severance, or transition income? When does it end?"* Capture amount + end date so the readout can show "current with this active" vs "post-end" projections.
