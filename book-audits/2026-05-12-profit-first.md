...
published: 2017 (revised and expanded edition; original 2014)
audited: 2026-05-12
...
- **You own a small business, have never separated business and personal cash, and currently treat profit as the residual after everything else** — *and* you find the appendix alone too compressed. In that case, the chapters that explain the foundational principle (owner is the key employee, must be paid a living wage minimum) and the Parkinson's-Law inversion are worth the persona-filtering tax. Even then, you'd skim, not read; aim for the **take-action steps at the end of each chapter** and ignore most of what surrounds them.
